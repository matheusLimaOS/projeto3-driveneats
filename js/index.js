let pratoPrincipal = {
  ...
  function selectPratoPrincipal(num) {
    let a = document.querySelector(
      ".pratoPrincipal li:nth-child(" + num + ") .prato"
    );
    let nome;
    let valor;
    ...
    let icone = document.querySelector(
      ".pratoPrincipal li:nth-child(" + num + ") .prato ion-icon"
    );
  
    icone.removeAttribute("class");
    nome = document.querySelector(
      ".pratoPrincipal li:nth-child(" + num + ") .prato h3"
    );
    valor = document.querySelector(
      ".pratoPrincipal li:nth-child(" + num + ") .prato .valor"
    );
  ...
  function selectBebida(num) {
    ...
    a.setAttribute("class", "prato active");
    let icone = document.querySelector(
      ".bebida li:nth-child(" + num + ") .prato ion-icon"
    );
    ...
    valor = document.querySelector(
      ".bebida li:nth-child(" + num + ") .prato .valor"
    );
    valor = valor.innerHTML;
    valor = valor.split(" ");
    valorFinal = valor[1].replace(",", ".");
  ...
  function selectSobremesa(num) {
    ...
    a.setAttribute("class", "prato active");
    let icone = document.querySelector(
      ".sobremesa li:nth-child(" + num + ") .prato ion-icon"
    );
  
    icone.removeAttribute("class");
    nome = document.querySelector(
      ".sobremesa li:nth-child(" + num + ") .prato h3"
    );
    valor = document.querySelector(
      ".sobremesa li:nth-child(" + num + ") .prato .valor"
    );
    valor = valor.innerHTML;
    valor = valor.split(" ");
    valorFinal = valor[1].replace(",", ".");
  ...
  function limpar(classe) {
    ...
    let todosIcone = document.querySelectorAll("." + classe + " ion-icon");
    let i = 0;
    for (i = 0; i < todosIcone.length; i++) {
      todosIcone[i].setAttribute("class", "displayNone");
    }
    if (todos !== null) {
  ...
  function popup() {
    ...
    let pratoPrincipalNome = document.querySelector(
      ".selectedPratoPrincipal p:nth-child(1)"
    );
    let pratoPrincipalValor = document.querySelector(
      ".selectedPratoPrincipal p:nth-child(2)"
    );
    ...
    let sobremesaNome = document.querySelector(
      ".selectedSobremesa p:nth-child(1)"
    );
    let sobremesaValor = document.querySelector(
      ".selectedSobremesa p:nth-child(2)"
    );
    ...
    tagA.setAttribute(
      "href",
      "https://wa.me/5562982322614?text=" + encodeURIComponent(string)
    );
